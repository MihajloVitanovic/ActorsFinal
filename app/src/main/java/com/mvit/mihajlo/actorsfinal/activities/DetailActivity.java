package com.mvit.mihajlo.actorsfinal.activities;
...
import com.mvit.mihajlo.actorsfinal.db.DatabaseHelper;
import com.mvit.mihajlo.actorsfinal.db.model.Actor;
import com.mvit.mihajlo.actorsfinal.db.model.Movie;
import java.sql.SQLException;
import java.util.List;
import static com.mvit.mihajlo.actorsfinal.activities.MainActivity.NOTIF_STATUS;
import static com.mvit.mihajlo.actorsfinal.activities.MainActivity.NOTIF_TOAST;
...
public class DetailActivity extends AppCompatActivity {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()){
            case R.id.detailmenu_add_movie:
                //OTVORI SE DIALOG, UNESETE INFORMACIJE
                final Dialog dialog = new Dialog(this);
                dialog.setContentView(R.layout.add_movie);

                Button add = (Button) dialog.findViewById(R.id.btn_add_movie);
