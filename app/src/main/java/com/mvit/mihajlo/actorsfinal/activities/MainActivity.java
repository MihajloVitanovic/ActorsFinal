...
import com.mvit.mihajlo.actorsfinal.dialogs.AboutDialog;
import com.mvit.mihajlo.actorsfinal.preferences.ToolbarPreferences;
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()){
            ...
            case R.id.listmenu_preferences:
                startActivity(new Intent(MainActivity.this, ToolbarPreferences.class));
                break;
        }
